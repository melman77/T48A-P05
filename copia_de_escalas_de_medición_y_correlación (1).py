...
Original file is located at
    https://colab.research.google.com/drive/1_DPTXWt401HGD9Ubaq1egI4FrpS7wVe8
...
def regresion_lineal_model_3():
  ...
  producto_desvio = desvio_x * desvio_y

  suma_producto_desvio = np.sum(producto_desvio)

  std_x = np.std(x, ddof=1)
  std_y = np.std(y, ddof=1)

  # Calcular el coeficiente de correlación de Pearson
  r = suma_producto_desvio / ((len(x) - 1) * std_x * std_y)
